...
<div class="container col-6 mb-3">
    ...
    <form action="${pageContext.request.contextPath}/add-more-info" method="post" class="m-1" id="form">
        ...
        <div class="form-group mt-1 mb-1">
            <label for="nationality"><%= language.getProperty("info.nationality.label") %></label>
