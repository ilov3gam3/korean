...
<div class="container col-6 mb-3">
    ...
    <form action="${pageContext.request.contextPath}/register" method="post" class="m-1" id="form">
        ...
        <div class="form-group mt-1 mb-1">
            ...
            <input required class="form-control" type="password" name="password" id="password" value="${not empty load_form.getPassword() ? load_form.getPassword() : ''}" placeholder="<%= language.getProperty("register.password.placeholder") %>">
        </div>
        <div class="form-group mt-1 mb-1">
        ...
        <div class="container-fluid text-center">
            <a href="${pageContext.request.contextPath}/login"><%= language.getProperty("register.login_instead") %></a>
        </div>
    </form>
</div>
<%@ include file="../master/foot.jsp" %>
<script>
    var selected = "${not empty load_form.getNationality() ? load_form.getNationality() : ''}"
